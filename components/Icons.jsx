...
export const EmptyImg = ({ className }) => {
	return (
		<svg
			width="385"
			height="385"
		...
		>
			...
			/>
			<path
				d="M191.998 167.626V197.469M116.021 224.334C108.954 236.271 117.795 251.188 131.938 251.188H252.058C266.201 251.188 275.042 236.271 267.974 224.334L207.914 122.885C200.843 110.941 183.153 110.941 176.082 122.885L116.021 224.334ZM191.998 221.344H192.059V221.404H191.998V221.344Z"
				stroke="#94A3B8"
				strokeWidth="12"
				stroke-linecap="round"
				stroke-linejoin="round"
...
export const PanelRight = ({ style }) => {
	return (
		...
		>
			<path
				d="M11.25 8.75C11.6642 8.75 12 8.41422 12 8C12 7.58579 11.6642 7.25 11.25 7.25L2.63642 7.25L5.76497 4.29526C6.06611 4.01085 6.07967 3.53617 5.79526 3.23503C5.51085 2.93389 5.03617 2.92033 4.73503 3.20474L0.235031 7.45474C0.0850145 7.59642 -3.58711e-07 7.79365 -3.49691e-07 8C-3.40671e-07 8.20635 0.0850145 8.40358 0.235031 8.54526L4.73503 12.7953C5.03617 13.0797 5.51085 13.0661 5.79526 12.765C6.07967 12.4638 6.06611 11.9892 5.76497 11.7047L2.63642 8.75L11.25 8.75Z"
				fill="currentColor"
			/>
			<path
				d="M10.75 14.5C10.3358 14.5 10 14.8358 10 15.25C10 15.6642 10.3358 16 10.75 16L13.25 16C14.7688 16 16 14.7688 16 13.25L16 2.75C16 1.23122 14.7688 -6.45564e-07 13.25 -5.79176e-07L10.75 -4.69897e-07C10.3358 -4.51792e-07 10 0.335786 10 0.75C10 1.16421 10.3358 1.5 10.75 1.5L13.25 1.5C13.9404 1.5 14.5 2.05964 14.5 2.75L14.5 13.25C14.5 13.9404 13.9404 14.5 13.25 14.5L10.75 14.5Z"
				fill="currentColor"
			/>
		</svg>
	);
...
export const HeroOrbisIcon = () => {
	return (
		<svg
			...
			xmlns="http://www.w3.org/2000/svg"
		>
			<g clipPath="url(#clip0_2866_8340)">
				<g opacity="0.1">
					<path
				...
				<g opacity="0.1">
					<path
						d="M75 140C110.899 140 140 110.899 140 75C140 39.1015 110.899 10 75 10C39.1015 10 10 39.1015 10 75C10 110.899 39.1015 140 75 140Z"
						fill="#4E75F6"
					/>
					<path
						d="M75 140C110.899 140 140 110.899 140 75C140 39.1015 110.899 10 75 10C39.1015 10 10 39.1015 10 75C10 110.899 39.1015 140 75 140Z"
				...
				<path
					d="M75 125C102.614 125 125 102.614 125 75C125 47.3858 102.614 25 75 25C47.3858 25 25 47.3858 25 75C25 102.614 47.3858 125 75 125Z"
					fill="#4E75F6"
				/>
				<circle cx="75" cy="69" r="18" stroke="white" strokeWidth="4" />
				<circle
					cx="75"
					cy="88.1304"
					r="11.0435"
...
export const HeroBloomGenesisIcon = () => {
	return (
		<img
			src="/coin.png"
...
export const HeroDaiIcon = () => {
	return (
		<svg
			...
			xmlns="http://www.w3.org/2000/svg"
		>
			<g clipPath="url(#clip0_2833_8258)">
				<g opacity="0.1">
					<path
						d="M75 150C116.421 150 150 116.421 150 75C150 33.5786 116.421 0 75 0C33.5786 0 0 33.5786 0 75C0 116.421 33.5786 150 75 150Z"
						fill="#FDC134"
				...
				<path
					fillRule="evenodd"
					clipRule="evenodd"
					d="M55.2311 53H73.1629C84.07 53 92.3379 58.818 95.4139 67.2841H101V72.4011H96.5905C96.6767 73.2096 96.7208 74.0334 96.7208 74.8704V74.9961C96.7208 75.9384 96.665 76.8647 96.5559 77.7719H101V82.8892H95.3076C92.1507 91.2373 83.9471 97 73.1629 97H55.2311V82.8892H49V77.7719H55.2311V72.4011H49V67.2841H55.2311V53ZM60.2442 82.8892V92.4097H73.1629C81.1349 92.4097 87.0577 88.5964 89.8151 82.8892H60.2442ZM91.3507 77.7719H60.2442V72.4011H91.3587C91.4741 73.2463 91.5332 74.1126 91.5332 74.9961V75.1218C91.5332 76.0256 91.4715 76.9104 91.3507 77.7719ZM73.1629 57.5827C81.1716 57.5827 87.1125 61.4964 89.8529 67.2841H60.2442V57.5827H73.1629Z"
					fill="white"
				/>
			</g>
			<defs>
				<clipPath id="clip0_2833_8258">
					<rect width="150" height="150" fill="white" />
				</clipPath>
			</defs>
		</svg>
	...
	return (
		...
		>
			<path
				fillRule="evenodd"
				clipRule="evenodd"
				d="M6.28033 3.21979C6.57322 3.51269 6.57322 3.98756 6.28033 4.28045L2.56066 8.00012L6.28033 11.7198C6.57322 12.0127 6.57322 12.4876 6.28033 12.7805C5.98744 13.0733 5.51256 13.0733 5.21967 12.7805L0.96967 8.53045C0.676777 8.23756 0.676777 7.76269 0.96967 7.46979L5.21967 3.21979C5.51256 2.9269 5.98744 2.9269 6.28033 3.21979ZM13.7197 3.21979C14.0126 2.9269 14.4874 2.9269 14.7803 3.21979L19.0303 7.46979C19.3232 7.76269 19.3232 8.23756 19.0303 8.53045L14.7803 12.7805C14.4874 13.0733 14.0126 13.0733 13.7197 12.7805C13.4268 12.4876 13.4268 12.0127 13.7197 11.7198L17.4393 8.00012L13.7197 4.28045C13.4268 3.98756 13.4268 3.51269 13.7197 3.21979Z"
				fill="currentColor"
			/>
			<path
				fillRule="evenodd"
				clipRule="evenodd"
				d="M11.3774 0.011027C11.7856 0.0814047 12.0595 0.469361 11.9891 0.877552L9.48909 15.3776C9.41872 15.7857 9.03076 16.0596 8.62257 15.9892C8.21438 15.9188 7.94053 15.5309 8.0109 15.1227L10.5109 0.622692C10.5813 0.214501 10.9692 -0.0593508 11.3774 0.011027Z"
				fill="currentColor"
			/>
		</svg>
	);
