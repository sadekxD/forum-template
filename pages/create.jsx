...
export default function Create() {
  ...
  return (
		<>
			<Head>
				{/** Title */}
				<title key="title">Share a new post | Bloom Genesis Forum</title>
				<meta
					property="og:title"
					content="Share a new post | Bloom Genesis Forum"
					key="og_title"
				/>
				...
				<div className="antialiased">
					<div className="min-h-screen flex">
						...
						<main className="grow overflow-hidden">
							...
							<Header />
							<Hero
								title="Sharing a new post on our forum"
								description="You are about to share a new post in the forum. Make sure to read our rules before doing so."
								image
							/>
