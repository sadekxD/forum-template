	...
	return (
		<>
			<Head>
				{/** Title */}
				<title key="title">
					Orbis Forum | Let&apos;s build web3 social together
				</title>
				<meta
					property="og:title"
					content="Orbis Forum | Let's build web3 social together"
					key="og_title"
				/>
				...
				<meta
					name="description"
					content="Discuss the future of Orbis and experience the power of Open Social on our Orbis Forum."
					key="description"
				></meta>
				<meta
				...
				<div className="antialiased">
					<div className="min-h-screen flex">
						...
						<main className="grow overflow-hidden">
							...
							{/*  Page sections */}
							<Hero
								title="Welcome to the Bloom Genesis Forum!"
								description="Respectful and good-faith discussion should be the cornerstone of any decision-making process. In trying to enact change, please keep this principle in mind."
								image={<HeroOrbisIcon />}
							/>
			...
			<span
				className={`relative transition duration-150 ease-in-out ${
					selected == category.stream_id
						...
						: "cursor-pointer text-secondary hover:text-[#333]"
				}`}
